...
model = ov.Core().read_model("./models/public/swin-tiny-patch4-window7-224/FP16_Batch4/swin-tiny-patch4-window7-224.xml")
...
def transform_fn(data_item):
    images, _ = data_item
    return np.vstack([images,images,images,images])
