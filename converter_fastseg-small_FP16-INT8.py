...
model = ov.Core().read_model("./models/public/fastseg-small/FP16/fastseg-small.xml")
...
int8_model_path = "./models/public/fastseg-small/FP16-INT8/fastseg-small.xml"
serialize(quantized_model, int8_model_path)


int8_model_path = "./models/public/fastseg-small/FP16-INT8_Batch4/fastseg-small.xml"
